...
Public Class crptBillPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ShowStore.crptBillPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptBillPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptBillPrint = New crptBillPrint
        rpt.Site = Me.Site
        Return rpt
    End Function
