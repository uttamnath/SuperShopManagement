...
Public Class crptdailyexpense
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ShowStore.crptdailyexpense.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrptdailyexpense
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptdailyexpense = New crptdailyexpense
        rpt.Site = Me.Site
        Return rpt
    End Function
