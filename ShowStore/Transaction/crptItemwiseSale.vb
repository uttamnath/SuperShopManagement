...
Public Class crptItemwiseSale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ShowStore.crptItemwiseSale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptItemwiseSale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptItemwiseSale = New crptItemwiseSale
        rpt.Site = Me.Site
        Return rpt
    End Function
